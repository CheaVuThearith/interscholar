                              ...
                              <div className="flex max-w-[700px] flex-col gap-y-7">
                                    <div className="flex flex-col gap-y-4">
                                          ...
                                          <p className="text-[#515050]">
                                                Our platform is your one-stop
                                                hub for all study opportunities,
                                                from competitions to
                                                scholarships, ensuring
                                                convenience at every click.
                                                Plus, with top-notch consultancy
                                                and seamless admission
                                                assistance, success is just a
                                                step away!
                                          </p>
                                    </div>
                              ...
                              <div className="flex flex-col gap-y-7 xl:w-[700px]">
                                    <div className="flex flex-col gap-y-4">
                                          ...
                                          <p className="text-[#515050]">
                                                ...
                                                need assistance, or just want to
                                                chat, don&apos;t hesitate to
                                                reach out. Our dedicated team is
                                                always here to provide you with
                                                the support and answers you
                                                need.
                                          </p>
                                    </div>
