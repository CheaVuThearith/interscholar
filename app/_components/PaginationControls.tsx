...
const PaginationControls = ({ data, className }: Props) => {
      ...
      const nextPage = () => {
            router.push(
                  `?page=${parseInt(page) + 1}&itemsPerPage=${itemsPerPage}`
            );
      };
      const prevPage = () => {
            router.push(
                  ...
                  {amountOfPages < 5
                        ...
                        : [
                                <button
                                      key={1}
                                      onClick={() => toPage(1)}
                                      className={`flex size-10 items-center justify-center rounded-lg ${parseInt(page) === 1 ? "bg-white" : "bg-[#f5f5f5]"}`}
                                >
                                      1
                                </button>,
                                            <button
